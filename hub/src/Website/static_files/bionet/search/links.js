(function($) {
  ...
  // var search_desc = '<div class="search-description"><ul><li>Check if your spelling is correct, or try removing filters.</li><li>Remove quotes around phrases to match each word individually: "blue drop" will match less than blue drop.</li></ul></div>';
    
  // $(search_desc).insertBefore( '.search-phrase' );
  ...
  for (var i = 0; i < jsonData.length; i++) {
    ...
    // modified for offline access
    var hrefLink = jsonObj.link + ".html";
